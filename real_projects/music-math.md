...
order: 3
header_image: /assets/images/music-math.png
...
{% include snippets/figure.md image_path="assets/images/partials.svg" alt="String partials" caption="Partials of a string tuned to $$C3=132\textrm{ Hz}$$. You may note that it actually forms a C major chord. Adapted from Wikipedia" %}
...
{% include snippets/figure.md image_path="assets/images/fifth_generation.gif" alt="Fifth relations for the chromatic scale" caption="Construction of the chromatic scale from fifth intervals." %}
