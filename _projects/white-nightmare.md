...
**Note** _This is a translation of the original story I wrote in Spanish, which you can find [below](#spanish)._
{: .notice--info}
...
{% include figure image_path="https://upload.wikimedia.org/wikipedia/commons/f/ff/Graph_based_maze_animation.gif" alt="graph-theory-based maze generation" caption="Source: Wikipedia" %}
...
[Mike Bostock's examples](https://bl.ocks.org/mbostock/11357811).
Make sure to check them out to learn more about this algorithm.

{% include figure image_path="assets/images/wilsons-algorithm.png" alt="color-flooded maze" caption="Maze generated by Wilson's algorithm. The path can be traced through color gradient. Source: cruzgodar.com" %}
...
- [Mike Bostock's Blocks](https://bl.ocks.org/mbostock/11357811) ---
